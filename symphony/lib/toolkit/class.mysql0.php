...
class MySQL
{
    ...
    public function connect($host = null, $user = null, $password = null, $port = '3306', $database = null)
    {
        ...
        try {
            #self::$mysqli = mysqli_real_connect(
    ...
    {
        mysqli_set_charset(self::$mysqli, $set);
    }
    ...
    public function query($query, $type = "OBJECT")
    {
        ...
        $this->_result = mysqli_query(self::$mysqli, $query);
        $this->_lastInsertID = mysqli_insert_id(self::$mysqli);
        self::$_query_count++;
    ...
    private function __error($type = null)
    {
        if ($type == 'connect') {
            ...
            $msg = mysqli_error(self::$mysqli);
            $errornum = mysqli_errno(self::$mysqli);
        }
